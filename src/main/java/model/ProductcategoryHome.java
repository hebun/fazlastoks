...
public class ProductcategoryHome {
	...
	public Productcategory findById(java.lang.Integer id) {
		...
		try {
			Productcategory instance = (Productcategory) sessionFactory
					.getCurrentSession().get("Productcategory", id);
			if (instance == null) {
	...
	public List<Productcategory> findByExample(Productcategory instance) {
		log.debug("finding Productcategory instance by example");
		try {
			List<Productcategory> results = (List<Productcategory>) sessionFactory
					.getCurrentSession().createCriteria("Productcategory")
